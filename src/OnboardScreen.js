...
export default function OnboardingScreen() {
  ...
  const handleStart = async () => {
    ...
    user.push({name: name, city: 'tree', money: 100, people: 1, happiness: 5, tax: 3, cars: 0, agro: 0, electroEnergy: 0, oil: 0, chemist: 0, securityService: 0, policeService: 0, firemanService: 0, medicineService: 0})
